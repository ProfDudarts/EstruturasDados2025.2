...
abstract class RbppavlCommon extends ArvoreAVL
{
     ...
     * @param object      $y    reference to the top node to be rebalanced
     * @param object      $q    reference to the parent of the found node
     * @param integer     $dir  reference to the direction of the found node
     * @param integer     $mode the search mode
     *
     * @return object the found node or null if not found
     *
     * @access protected
     */
     ...
     * @param RbppavlTree $tree a árvore a ser pesquisada
     * @param object      $node nó para iniciar a pesquisa
     * @return object nó anterior em sequência in-order ou null se o nó mais à esquerda for a entrada
     * @access protected
     * 
     */
     ...
     * @param object      $node nó para iniciar a pesquisa
     *
     * @return object próximo nó em sequência in-order ou null se o nó mais à direita for a entrada
     *
     * @access protected
     */
    ...
    /**
      ...
      * @param RbppavlTree $tree a árvore a ser pesquisada
      *
      * @return object o nó mais à esquerda na árvore ou null se a árvore estiver vazia.
      */
     ...
     * @param RbppavlTree $tree a árvore a ser pesquisada
     *
     * @return object o nó mais à direita na árvore ou null se a árvore estiver vazia.
     */
     ...
     * @param array   $params parâmetros para qualificar a mensagem
